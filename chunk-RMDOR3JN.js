import{a as A,b as me}from"./chunk-LIBYA7D4.js";import"./chunk-JVO36D4K.js";import{o as oe,p as ae}from"./chunk-AW4276X3.js";import{Ab as f,Bb as T,Fa as Y,Fb as ie,Ga as Z,La as $,Pa as ee,U as K,Wa as te,Z as X,j as h,nb as ne,w as J}from"./chunk-5KGSWRT5.js";import"./chunk-PUSYLN2N.js";import{Fa as d,Ga as t,Ha as n,Ia as i,J as g,Kb as q,Kc as s,Nb as V,Nc as j,Oc as R,P as y,Pa as k,Q as C,Qa as u,Qc as z,Rc as B,Uc as W,Vc as G,Wa as _,Xa as N,Ya as F,Zc as U,cb as M,db as e,dd as H,fb as O,fd as Q,hb as P,hd as w,ia as l,ib as D,jb as L,na as S,pa as E,qa as b,sb as I}from"./chunk-A2WYYMKN.js";import"./chunk-NCEQPEJE.js";var he=["reactiveFormData"],le=(()=>{class m{cdr;fb;thfTheme;reactiveFormModal;a11yLevel;a11yLevelStorage="po-a11y-AA";reactiveForm;theme=0;themeStorage="po-theme-default";a11yChangeListenerAAA;a11yChangeListenerAA;themeChangeListenerDark;themeChangeListenerDefault;a11yLevelOptions=[{label:"AA",value:"AA"},{label:"AAA",value:"AAA"}];themeOptions=[{label:"Light",value:0},{label:"Dark",value:1}];modalPrimaryAction={action:()=>this.reactiveFormModal.close(),label:"Close"};constructor(r,a,o){this.cdr=r,this.fb=a,this.thfTheme=o;let p=this.thfTheme.applyTheme();this.a11yLevel=h.AA,p?(this.theme=typeof p.active=="object"?p.active.type:p.active||0,this.a11yLevel=typeof p.active=="object"?p.active.a11y||h.AA:h.AA):this.thfTheme.setTheme(A,this.theme,this.a11yLevel),this.createReactiveForm()}ngOnInit(){localStorage.getItem("po-ui-theme")&&(this.themeStorage=localStorage.getItem("po-ui-theme")),this.theme=this.themeStorage==="po-theme-default"?0:1,this.changeTheme(this.theme,!1),localStorage.getItem("po-ui-a11y")&&(this.a11yLevelStorage=localStorage.getItem("po-ui-a11y")),this.a11yLevel=this.a11yLevelStorage==="po-a11y-AAA"?h.AAA:h.AA,this.changeA11yLevel(this.a11yLevel,!1),this.themeChangeListenerDefault=()=>{this.changeTheme(0,!1),this.theme=0},this.themeChangeListenerDark=()=>{this.changeTheme(1,!1),this.theme=1},this.a11yChangeListenerAAA=()=>{this.changeA11yLevel(h.AAA,!1),this.a11yLevel=h.AAA},this.a11yChangeListenerAA=()=>{this.changeA11yLevel(h.AA,!1),this.a11yLevel=h.AA},window.addEventListener("po-a11y-AA",this.a11yChangeListenerAA),window.addEventListener("po-a11y-AAA",this.a11yChangeListenerAAA),window.addEventListener("po-theme-default",this.themeChangeListenerDefault),window.addEventListener("po-theme-dark",this.themeChangeListenerDark)}ngOnDestroy(){window.removeEventListener("po-theme-default",this.themeChangeListenerDefault),window.removeEventListener("po-theme-dark",this.themeChangeListenerDark),window.removeEventListener("po-a11y-AA",this.a11yChangeListenerAA),window.removeEventListener("po-a11y-AAA",this.a11yChangeListenerAAA)}changeA11yLevel(r,a=!0){this.thfTheme.setTheme(A,this.theme,r),r==="AA"?localStorage.setItem("po-ui-a11y","po-a11y-AA"):localStorage.setItem("po-ui-a11y","po-a11y-AAA"),a&&window.dispatchEvent(new Event("po-sample-change-a11y"))}changeTheme(r,a=!0){this.thfTheme.setTheme(A,r,this.a11yLevel),r===1?localStorage.setItem("po-ui-theme","po-theme-dark"):localStorage.setItem("po-ui-theme","po-theme-default"),a&&window.dispatchEvent(new Event("po-sample-change-theme"))}createReactiveForm(){this.reactiveForm=this.fb.group({name:["",s.compose([s.required,s.minLength(5),s.maxLength(30)])],address:["",s.compose([s.required,s.minLength(5),s.maxLength(50)])],number:["",s.compose([s.required,s.min(1),s.max(99999)])],email:["",s.required],website:["",s.required]})}saveForm(){this.reactiveFormModal.open()}static \u0275fac=function(a){return new(a||m)(S(q),S(U),S(me))};static \u0275cmp=E({type:m,selectors:[["sample-po-theme-labs"]],viewQuery:function(a,o){if(a&1&&_(he,7),a&2){let p;N(p=F())&&(o.reactiveFormModal=p.first)}},standalone:!1,decls:22,vars:12,consts:[["reactiveFormData",""],["p-title","Example"],[3,"formGroup"],["formControlName","name","p-clean","","p-icon","an an-user","p-label","Customer name",1,"po-lg-6"],["formControlName","email","p-label","Email","p-clean","",1,"po-lg-6"],["formControlName","address","p-clean","","p-icon","an an-map-pin","p-label","Address",1,"po-lg-4","po-md-8"],["formControlName","number","p-label","Number","p-clean","",1,"po-lg-2","po-md-4"],["formControlName","website","p-label","Website","p-clean","",1,"po-lg-6"],[1,"po-row"],["p-label","Save",1,"po-md-3",3,"p-click","p-disabled"],["p-title","Save successful",3,"p-primary-action"],["p-label","Name",1,"po-md-12",3,"p-value"],["p-label","Address",1,"po-md-6",3,"p-value"],["p-label","Number",1,"po-md-6",3,"p-value"],["p-label","Email",1,"po-md-6",3,"p-value"],["p-label","Website",1,"po-md-6",3,"p-value"],[1,"po-row","po-mt-3"],["name","theme","p-label","Theme Type",1,"po-md-6",3,"ngModelChange","p-change","ngModel","p-options"],["name","a11ylevel","p-label","Acessibility Level",1,"po-md-6",3,"ngModelChange","p-change","ngModel","p-options"]],template:function(a,o){if(a&1){let p=k();t(0,"po-widget",1)(1,"form",2),i(2,"po-input",3)(3,"po-email",4)(4,"po-input",5)(5,"po-number",6)(6,"po-url",7),t(7,"div",8)(8,"po-button",9),u("p-click",function(){return o.saveForm()}),n()()(),t(9,"po-modal",10,0)(11,"div",8),i(12,"po-info",11),n(),t(13,"div",8),i(14,"po-info",12)(15,"po-info",13),n(),t(16,"div",8),i(17,"po-info",14)(18,"po-info",15),n()()(),t(19,"div",16)(20,"po-radio-group",17),L("ngModelChange",function(c){return y(p),D(o.theme,c)||(o.theme=c),C(c)}),u("p-change",function(c){return o.changeTheme(c)}),n(),t(21,"po-radio-group",18),L("ngModelChange",function(c){return y(p),D(o.a11yLevel,c)||(o.a11yLevel=c),C(c)}),u("p-change",function(c){return o.changeA11yLevel(c)}),n()()}a&2&&(l(),d("formGroup",o.reactiveForm),l(7),d("p-disabled",!o.reactiveForm.valid),l(),d("p-primary-action",o.modalPrimaryAction),l(3),d("p-value",o.reactiveForm.controls.name.value),l(2),d("p-value",o.reactiveForm.controls.address.value),l(),d("p-value",o.reactiveForm.controls.number.value),l(2),d("p-value",o.reactiveForm.controls.email.value),l(),d("p-value",o.reactiveForm.controls.website.value),l(2),P("ngModel",o.theme),d("p-options",o.themeOptions),l(),P("ngModel",o.a11yLevel),d("p-options",o.a11yLevelOptions))},dependencies:[B,j,R,z,G,W,J,Y,Z,$,K,ee,te,X,ie],encapsulation:2})}return m})();var Ee=m=>({"docs-sample-code-tabs":m}),de=(()=>{class m{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="an an-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"an an-plus":"an an-minus"}static \u0275fac=function(a){return new(a||m)};static \u0275cmp=E({type:m,selectors:[["sample-po-theme-labs-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(a,o){a&1&&(i(0,"br"),t(1,"blockquote",0)(2,"label",1),e(3,"PO Theme Labs"),n(),t(4,"a",2),u("click",function(){return o.toggleSampleCodeTabs()}),i(5,"span"),e(6),n()(),t(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),e(12,"sample-po-theme-labs/sample-po-theme-labs.component.html"),n(),t(13,"pre",7),e(14,`<po-widget p-title="Example">
...
export class SamplePoThemeLabsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private thfTheme: ThfThemeService
  ) {
    const _poTheme = this.thfTheme.applyTheme();
    this.a11yLevel = PoThemeA11yEnum.AA;

    if (!_poTheme) {
      this.thfTheme.setTheme(poThemeTotvs, this.theme, this.a11yLevel);
    } else {
      this.theme = typeof _poTheme.active === 'object' ? _poTheme.active.type : (_poTheme.active || 0);
      this.a11yLevel = typeof _poTheme.active === 'object' ? (_poTheme.active.a11y || PoThemeA11yEnum.AA) : PoThemeA11yEnum.AA;
    }
  ...
  changeA11yLevel(value: PoThemeA11yEnum, dispatchEvent = true) {
    this.thfTheme.setTheme(poThemeTotvs, this.theme, value);
    value === 'AA'
  ...
  changeTheme(value: number, dispatchEvent = true) {
    this.thfTheme.setTheme(poThemeTotvs, value, this.a11yLevel);
    value === 1
...
`),n()()(),t(1165,"h4",7),e(1166,"Propriedades"),n(),t(1167,"table",14)(1168,"tr",15)(1169,"th",16),e(1170,"Nome"),n(),t(1171,"th",16),e(1172,"Descri\xE7\xE3o"),n()(),t(1173,"tr",9)(1174,"td",17)(1175,"div",11)(1176,"span",12),e(1177," light"),i(1178,"br"),n()()(),t(1179,"td",13)(1180,"p"),e(1181,"Define o tema como claro."),n()()(),t(1182,"tr",9)(1183,"td",17)(1184,"div",11)(1185,"span",12),e(1186," dark"),i(1187,"br"),n()()(),t(1188,"td",13)(1189,"p"),e(1190,"Define o tema como escuro."),n()()()()())},encapsulation:2})}return m})();var se=(()=>{class m{route;router;sub;hidePoWebSample=!0;samplesLength=1;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(r,a){this.route=r,this.router=a}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(r=>{let a=r.view;this.activeTab=a||"doc",this.hidePoWebSample=this.samplesLength===0})}changeTab(r){this.router.navigate([],{queryParams:{view:r},queryParamsHandling:"merge"}),this.activeTab=r}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(a){return new(a||m)(S(H),S(Q))};static \u0275cmp=E({type:m,selectors:[["ng-component"]],standalone:!1,decls:6,vars:4,consts:[["p-title","Theme",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-click","p-active"],["p-label","Exemplos",3,"p-click","p-hide","p-active"]],template:function(a,o){a&1&&(t(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),u("p-click",function(){return o.changeTab("doc")}),i(3,"sample-po-theme-doc"),n(),t(4,"po-tab",3),u("p-click",function(){return o.changeTab("web")}),i(5,"sample-po-theme-labs-view"),n()()()),a&2&&(d("p-actions",o.actions),l(2),d("p-active",o.activeTab==="doc"),l(2),d("p-hide",o.hidePoWebSample)("p-active",o.activeTab==="web"))},dependencies:[ne,f,T,de,pe],encapsulation:2})}return m})();var ve=[{path:"",component:se}],ce=(()=>{class m{static \u0275fac=function(a){return new(a||m)};static \u0275mod=b({type:m});static \u0275inj=g({imports:[w.forChild(ve),w]})}return m})();var ze=(()=>{class m{static \u0275fac=function(a){return new(a||m)};static \u0275mod=b({type:m});static \u0275inj=g({imports:[ae,ce]})}return m})();export{ze as DocPoThemeModule};
